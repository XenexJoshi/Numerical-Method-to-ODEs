    ...
    <>
      ...
      <div className="wrapper">
        <div className="handler">
          <div className="card">
            <p> This calculator generates an Adams-Bashforth linear multi-step
              approximation to the input first-order differential equation y' = f(t, y).
            </p>
            <br />
        ...
        <div className="plot">
          <Plot data={[
            ...
            layout={{
              width: 580, height: 530, title: 'Adams-Bashforth Approximation of y(t)',
              font: "Calibri"
            }} />
        </div>
      </div>
